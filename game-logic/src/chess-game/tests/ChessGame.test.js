...
describe('ChessGame Testing', () => {
  ...
  describe('Threefold repetition rule', () => {
    test('Repeating the same position 3 times (doesn\'t have to be done consecutively) leads to a draw', () => {
      const chessGame = new ChessGame('test')
      chessGame.expectGameStatusesAfterMoves([[[[0, 6], [2, 5]], 1],
        [[[7, 6], [5, 5]], 0],
        [[[2, 5], [0, 6]], 1],
        [[[7, 1], [5, 2]], 0],
        [[[0, 6], [2, 5]], 1],
      ...
      const chessGame2 = new ChessGame('test')
      chessGame2.expectGameStatusesAfterMoves([[[[1, 4], [3, 4]], 1],
        [[[6, 4], [4, 4]], 0],
        [[[0, 6], [2, 5]], 1],
        [[[7, 1], [5, 2]], 0],
        [[[0, 5], [4, 1]], 1],
    ...
    test('Loss of castling rights is accounted for', () => {
      const chessGame = new ChessGame('test')
      chessGame.expectGameStatusesAfterMoves([[[[1, 4], [2, 4]], 1],
        [[[6, 4], [5, 4]], 0],
        [[[0, 4], [1, 4]], 1],
        [[[7, 4], [6, 4]], 0],
        [[[1, 4], [0, 4]], 1],
    ...
    test('Positions in which an en passant is possible are ignored (as they can\'t be repeated)', () => {
      const chessGame = new ChessGame('test')
      chessGame.expectGameStatusesAfterMoves([[[[1, 4], [3, 4]], 1],
        [[[6, 4], [5, 4]], 0],
        [[[3, 4], [4, 4]], 1],
